...
Using PyMongo without BSON library conflicts
"""
...
class BaseModel:
    """Base model with common functionality - using string IDs instead of ObjectId"""
    
    def __init__(self, collection_name: str):
        self.collection = db[collection_name]
    
    def _generate_id(self) -> str:
        """Generate a string-based unique ID"""
    ...
    def update_by_id(self, doc_id: str, update_data: Dict) -> bool:
        ...
        return self.update_one({"_id": doc_id}, update_data)
    ...
    def delete_by_id(self, doc_id: str) -> bool:
        ...
        return self.delete_one({"_id": doc_id})
