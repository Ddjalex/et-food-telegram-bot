...
Using custom MongoDB client without dependency conflicts
"""
...
class BaseModel:
    ...
    def insert_one(self, data: Dict) -> str:
        ...
        return self.client.insert_one(self.collection_name, data)
    
    def find_one(self, filter_dict: Dict) -> Optional[Dict]:
        """Find a single document"""
        return self.client.find_one(self.collection_name, filter_dict)
    
    def find_by_id(self, doc_id: str) -> Optional[Dict]:
        """Find document by ID"""
        return self.find_one({"id": doc_id})
    
    def find_many(self, filter_dict: Dict = None, sort: str = None, limit: int = None) -> List[Dict]:
        """Find multiple documents"""
        return self.client.find_many(self.collection_name, filter_dict, sort, limit)
    
    def update_one(self, filter_dict: Dict, update_data: Dict) -> bool:
        """Update a single document"""
        return self.client.update_one(self.collection_name, filter_dict, update_data)
    
    def update_by_id(self, doc_id: str, update_data: Dict) -> bool:
        """Update document by ID"""
        return self.update_one({"id": doc_id}, update_data)
    
    def delete_one(self, filter_dict: Dict) -> bool:
        """Delete a single document"""
        return self.client.delete_one(self.collection_name, filter_dict)
    
    def delete_by_id(self, doc_id: str) -> bool:
        """Delete document by ID"""
        return self.delete_one({"id": doc_id})
    
    def count(self, filter_dict: Dict = None) -> int:
        """Count documents"""
        return self.client.count_documents(self.collection_name, filter_dict)
...
class MenuItem(BaseModel):
    ...
    def get_by_restaurant(self, restaurant_id: str, available_only: bool = True) -> List[Dict]:
        ...
        return self.find_many(filter_dict, sort='category')
...
class Order(BaseModel):
    ...
    def get_by_restaurant(self, restaurant_id: str, status: str = None) -> List[Dict]:
        ...
        return self.find_many(filter_dict, sort='created_at')
    
    def get_by_customer(self, telegram_user_id: str) -> List[Dict]:
        """Get orders for a customer"""
        return self.find_many({'telegram_user_id': telegram_user_id}, sort='created_at')
...
class PaymentTransaction(BaseModel):
    ...
    def get_by_order(self, order_id: str) -> List[Dict]:
        ...
        return self.find_many({'order_id': order_id}, sort='created_at')
...
class Category(BaseModel):
    ...
    def get_active_categories(self) -> List[Dict]:
        ...
        return self.find_many({'is_active': True}, sort='sort_order')
