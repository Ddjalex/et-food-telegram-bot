#!/usr/bin/env python3
"""
Restore complete 64-item menu for Flavour cafe in MongoDB
"""
...
def restore_flavour_cafe_menu():
    """Restore complete Flavour cafe menu with 64 food products across 14 categories"""
    ...
    with app.app_context():
        ...
        for category in categories:
            count = menu_item_model.count({'restaurant_id': flavour_cafe['id'], 'category': category})
